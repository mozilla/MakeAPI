  ...
  return {
    ...
    build: function( query, callback ) {
      ...
      var baseQuery = {
        ...
        // I'm reusing this code to search for a dsl query.
        if( !!query.metric){
     var newDateZero=function(d){
        var d =new Date();
           d.setHours(0);
           d.setMinutes(0);
           d.setSeconds(0);
    ...
    var today=function (){
      return newDateZero().getTime();
             ...
             console.log("LOG: "+query.metric);
            if (query.metric=='all'){
                   // NO NEED TO DO ANYTHING HERE IT WILL DISPLAY ALL METRICS
            } else if (query.metric=='day'){
                baseQuery.query.filter= {
                          range : {
                            createdAt : { 
                                gte : today(), 
                                lt : nextDay(1), 
             ...
             baseQuery.query.filtered.filter={ 
                          bool:{
                          must :{},
                          should :{},
                          must_not :{
      ...
      console.log("LOG: "+JSON.stringify(baseQuery.query));
